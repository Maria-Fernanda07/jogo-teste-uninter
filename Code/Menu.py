...
from Code.Const import WIN_WIDTH, COR_AZUL, MENU_OPTION, COR_VERDE, COR_LARANJA
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    ...
                    self.menu_text(text_size = 30, text = MENU_OPTION[i], text_color = COR_LARANJA, text_center_pos = ((WIN_WIDTH / 2), 160 + 40 * i))
                else:
